...
def main(args):
    ...
    interractions = interractions.loc[:,~interractions.columns.str.contains('\*')]
    ...
    AUC = AUC.loc[~AUC.index.str.contains('\*')]
    ...
    for seed in range(seed1,seed_end):
        ...
        for train_index, test_index in skf.split(X, y):
            ...
            pickle.dump(clf, open(out+'LogisticRegression_'+str(seed)+'_'+str(i+1)+'.pkl', 'wb'))
